...
app.get('/api/health', (req, res) => {
  ...
  res.json({
    ...
    endpoints: {
      ...
      createCheckout: `POST ${baseUrl}/api/create-checkout` // ✅ ADDED: Checkout endpoint
    },
...
// 💳 Create Stripe Checkout Session - ✅ ADDED BACK
...
app.use((req, res) => {
  ...
  res.status(404).json({ 
    ...
    availableEndpoints: [
      ...
      `${baseUrl}/api/create-checkout`, // ✅ ADDED: Show in available endpoints
...
app.listen(PORT, () => {
  ...
  console.log(`   Create Checkout: https://papir.ca/api/create-checkout`); // ✅ ADDED: Show in startup log
  ...
  console.log('   ✅ Stripe payment integration'); // ✅ ADDED: Show feature
